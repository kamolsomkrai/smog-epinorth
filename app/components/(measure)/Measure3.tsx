...
const Measure3: React.FC<Props> = ({ activityFormData, handleChange }) => (
  <div className="mt-6 space-y-8">
    ...
    <fieldset className="border border-gray-300 p-6 rounded-lg">
      ...
      <InputRow fields={getSection31Fields(activityFormData)} handleChange={handleChange} />
    </fieldset>

    {/* 3.2 คลินิกมลพิษออนไลน์ */}
    <fieldset className="border border-gray-300 p-6 rounded-lg">
      <legend className="text-lg font-semibold text-gray-800">3.2 คลินิกมลพิษออนไลน์</legend>
      <InputRow fields={getSection32Fields(activityFormData)} handleChange={handleChange} />
    </fieldset>

    <fieldset className="border border-gray-300 p-6 rounded-lg">
      <legend className="text-lg font-semibold text-gray-800">มุ้งสู้ฝุ่น</legend>
      <InputRow fields={getSection321Fields(activityFormData)} handleChange={handleChange} />
    </fieldset>
    ...
    <fieldset className="border border-gray-300 p-6 rounded-lg">
      ...
      <div className="mt-4">
        ...
        <InputRow fields={getSection331Fields(activityFormData)} handleChange={handleChange} />
      </div>
      ...
      <div className="mt-6">
        ...
        <InputRow fields={getSection332Fields(activityFormData)} handleChange={handleChange} />
      </div>
      ...
      <div className="mt-6">
        ...
        <InputRow fields={getSection333Fields(activityFormData)} handleChange={handleChange} />
      </div>
      ...
      <div className="mt-6">
        ...
        <InputRow fields={getSection334Fields(activityFormData)} handleChange={handleChange} />
      </div>
      ...
      <div className="mt-6">
        ...
        <InputRow fields={getSection335Fields(activityFormData)} handleChange={handleChange} />
      </div>
    </fieldset>
    ...
    <fieldset className="border border-gray-300 p-6 rounded-lg">
      ...
      <div className="mt-6">
        ...
        <InputRow fields={getSection358Fields(activityFormData)} handleChange={handleChange} />
      </div>
    </fieldset>
    ...
    <fieldset className="border border-gray-300 p-6 rounded-lg">
      ...
      <InputRow fields={getSection36Fields(activityFormData)} handleChange={handleChange} />
    </fieldset>
  </div>
);
